...
function detect(dir) {
  ...
  return 'claude'; // safe default — creates or appends to CLAUDE.md
}
...
if (!fs.existsSync(skillSrc)) {
  ...
  console.error('Make sure you cloned the full context-optimizer repo.');
  process.exit(1);
}
...
// For CLAUDE.md — append if file exists and skill not already present
